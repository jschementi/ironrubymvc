...
namespace IronRubyMvc.Tests
{
    ...
    public class RubyExperiments : IUseFixture<RubyRuntime>
    {
        ...
        {
            var script = "class MyClass; def my_method; $text_var = \"Hello world\"; end; end; MyClass.new.my_method ";
...
//            instance.ShouldNotBeNull();
        ...
        public void ShouldBeAbleToInvokeInstanceMethods()
        {
            ...
            operations.Call(method, "DLR context").ToString().ShouldBeEqualTo("DLR context is expired ");
        ...
        private void AddClass(MethodBase method)
        {
            ...
            var script = "class {0}; def my_method; $text_var = \"{1}\"; end; def another_method; $text_var = 'from other method'; end; end ".FormattedWith("{0}Class".FormattedWith(methodName), methodName);
            _context.DefineGlobalVariable("text_var", "String value");
