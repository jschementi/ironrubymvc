...
module ActiveModel
  module NamedScope
    # All subclasses of ActiveModel::Base have two named \scopes:
    ...
    module ClassMethods
      ...
      #
      # All \scopes are available as class methods on the ActiveModel::Base descendent upon which the \scopes were defined. But they are also available to
